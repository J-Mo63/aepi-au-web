...
class BlogPostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blog_post" do
    assert_difference('BlogPost.count') do
      post blog_posts_url, params: { blog_post: { body: @blog_post.body, image: @blog_post.image, is_published: @blog_post.is_published, title: @blog_post.title } }
    end
  ...
  test "should update blog_post" do
    patch blog_post_url(@blog_post), params: { blog_post: { body: @blog_post.body, image: @blog_post.image, is_published: @blog_post.is_published, title: @blog_post.title } }
