...
class SnapsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create snap" do
    assert_difference('Snap.count') do
      post snaps_url, params: { snap: { comment_id: @snap.comment_id, user_id: @snap.user_id } }
    end
  ...
  test "should update snap" do
    patch snap_url(@snap), params: { snap: { comment_id: @snap.comment_id, user_id: @snap.user_id } }
